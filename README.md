...
uv run python src/datafun_03_analytics/app_asbourgeois.py
```
...
1. Rename `app_asbourgeois.py` to reflect your name or alias.
...
2. Edit this README.md file to change the run command to call your file instead.
   Use CTRL+f to search for `app_asbourgeois.py` and replace all occurrences exactly.
